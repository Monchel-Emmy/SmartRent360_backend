      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            role: {
              type: "string",
              enum: ["ADMIN", "COMMISSIONER", "LANDLORD", "TENANT"],
            },
        ...
        RegisterRequest: {
          ...
          properties: {
            ...
            role: {
              type: "string",
              enum: ["TENANT", "LANDLORD", "COMMISSIONER"],
              example: "TENANT",
            },
    ...
    tags: [
      {
        name: "Users",
        description:
          "User management endpoints (registration, login, verification)",
      },
      {
        name: "Properties",
        description:
          "Property management endpoints (CRUD operations, search, verification)",
      },
      {
        name: "Requests",
        description:
          "Tenant request endpoints (submit interest, manage requests)",
      },
      {
        name: "Commissions",
